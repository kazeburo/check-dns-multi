...
- go: bump the dependencies group with 2 updates by @dependabot[bot] in https://github.com/kazeburo/check-dns-multi/pull/7
- ci: bump actions/setup-go from 6.3.0 to 6.4.0 in the dependencies group by @dependabot[bot] in https://github.com/kazeburo/check-dns-multi/pull/9
- go: bump github.com/mackerelio/checkers from 0.2.0 to 0.2.1 in the dependencies group by @dependabot[bot] in https://github.com/kazeburo/check-dns-multi/pull/11
- ci: bump Songmu/tagpr from 1.17.1 to 1.18.1 in the dependencies group by @dependabot[bot] in https://github.com/kazeburo/check-dns-multi/pull/10
